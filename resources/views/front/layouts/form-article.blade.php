        ...
        <div class="articles">
            ...
            <div class="view">
                <div class="row">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all; width: 1917px;"><div class="owl-item active" style="width: 373.333px; margin-left: 10px;"><div class="card">
                            <div class="photo">
